...
namespace MiPrimerCRUD.Controllers
{
    public class AsignaturasController : Controller
    {
        ...
        {
            var miContexto = _context.Asignaturas.Include(a => a.Curso);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,CursoId")] Asignatura asignatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Nombre,CursoId")] Asignatura asignatura)
        {
            if (id != asignatura.Id)
            {
                return NotFound();
